...
#
#
input_folder = 'C:\\Users\\infin\\OneDrive - 東海大學\\Desktop\\MachineLearning\\images'
# input_folder = 'bird/yes'
cat_folder   = 'C:\\Users\\infin\\OneDrive - 東海大學\\Desktop\\MachineLearning\\images\\cats'
dog_folder   = 'C:\\Users\\infin\\OneDrive - 東海大學\\Desktop\\MachineLearning\\images\\dogs'
Fruit_classes_folder = 'C:\\Users\\infin\\OneDrive - 東海大學\\Desktop\\MachineLearning\\images\\Fruit'
...
#
Fruit_classes = [
    'pineapple', 'banana', 'lemon', 'strawberry', 'orange'   
]
...
for filename in os.listdir(input_folder):
    if filename.endswith(('.jpg', '.JPG', '.jpeg', '.png')):  # Check if the file is an image
        ...
        if classification in cat_classes:
            ...
            shutil.move(img_path, os.path.join(Fruit_classes_folder, filename))
            print(f'{filename} moved to {Fruit_classes_folder}')
        else:
